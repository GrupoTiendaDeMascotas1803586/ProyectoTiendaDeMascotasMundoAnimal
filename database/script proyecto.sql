...
CREATE TABLE IF NOT EXISTS `proyecto`.`compra` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_COMPRA_PERSONA1` (`PERSONA_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `proyecto`.`mascota` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_MASCOTA_RAZA` (`RAZA_id` ASC) VISIBLE,
  INDEX `fk_MASCOTA_PERSONA1` (`PERSONA_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `proyecto`.`inventario` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_INVENTARIO_COMPRA1` (`COMPRA_id` ASC) VISIBLE,
  INDEX `fk_INVENTARIO_MASCOTA1` (`MASCOTA_id` ASC) VISIBLE,
  INDEX `fk_INVENTARIO_ELEMENTO1` (`ELEMENTO_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `proyecto`.`venta` (
  ...
  `PERSONA_id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_VENTA_PERSONA1` (`PERSONA_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `proyecto`.`articulosventa` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_ARTICULOSVENTA_INVENTARIO1` (`INVENTARIO_id` ASC) VISIBLE,
  INDEX `fk_ARTICULOSVENTA_VENTA1` (`VENTA_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `proyecto`.`cita` (
  ...
  `VENTA_id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_CITA_PERSONA1` (`PERSONA_id` ASC) VISIBLE,
  INDEX `fk_CITA_VENTA1` (`VENTA_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `proyecto`.`descripcion` (
  ...
  `MASCOTA_id` INT(10) UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_DESCRIPCION_SERVICIO1` (`SERVICIO_id` ASC) VISIBLE,
  INDEX `fk_DESCRIPCION_CITA1` (`CITA_id` ASC) VISIBLE,
  INDEX `fk_DESCRIPCION_MASCOTA1` (`MASCOTA_id` ASC) VISIBLE,
