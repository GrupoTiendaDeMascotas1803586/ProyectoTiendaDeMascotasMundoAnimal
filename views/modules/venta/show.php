    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="card-header">
                <h3 class="card-title"><?= $DataVENTA->getFecha()  ?></h3>
            </div>
            <div class="card-body">
                <p>
                <hr>
                <strong><i class="fas fa-user mr-1"></i> Fecha</strong>
                <p class="text-muted"><?= $DataVENTA->getFecha().": ".$DataVENTA->getFecha() ?></p>
                <hr>
                <strong><i class="far fa-file-alt mr-1"></i> Subtotal</strong>
                <p class="text-muted"><?= $DataVENTA->getSubtotal()." - ".$DataVENTA->getSubtotal() ?></p>
                <strong><i class="far fa-file-alt mr-1"></i> TotalApagar</strong>
                <p class="text-muted"><?= $DataVENTA->getTotalApagar()." - ".$DataVENTA->getTotalApagar() ?></p>
                </p>
        ...
        <div class="row">
            <div class="col-auto mr-auto">
                <a role="button" href="index.php" class="btn btn-success float-right" style="margin-right: 5px;">
                    <i class="fas fa-tasks"></i> Gestionar Venta
                </a>
            </div>
            <div class="col-auto">
